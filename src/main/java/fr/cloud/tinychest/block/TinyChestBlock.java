...
import fr.cloud.tinychest.blockentity.TinyChestBlockEntity;
...
public class TinyChestBlock extends ChestBlock {
    ...
    public TinyChestBlock() {
        super(FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD), () -> BlockEntities.TINY_CHEST_BLOCK_ENTITY);
    }
